...
class TestReserveRule(common.SavepointCase):
    ...
    def test_rule_take_all_in_2(self):
        self._update_qty_in_location(self.loc_zone1_bin1, self.product1, 200)
        self._update_qty_in_location(self.loc_zone2_bin1, self.product1, 200)
        self._update_qty_in_location(self.loc_zone3_bin1, self.product1, 200)
        ...
        self.assertEqual(ml.location_id, self.loc_zone2_bin1)
    ...
    def test_rule_only_full_quantity(self):
        ...
        self._create_rules([
            # this rule should be excluded because we would not empty the bin
            {
                'location_id': self.loc_zone1.id,
                'sequence': 1,
